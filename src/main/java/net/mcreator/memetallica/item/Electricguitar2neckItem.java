...
public class Electricguitar2neckItem extends MemetallicaModElements.ModElement {
	@ObjectHolder("memetallica:electricguitar_2neck")
	public static final Item block = null;
	public Electricguitar2neckItem(MemetallicaModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("electricguitar_2neck");
		}
