...
public class TheaxeneckItem extends MemetallicaModElements.ModElement {
	@ObjectHolder("memetallica:theaxeneck")
	public static final Item block = null;
	public TheaxeneckItem(MemetallicaModElements instance) {
		super(instance, 60);
	}
