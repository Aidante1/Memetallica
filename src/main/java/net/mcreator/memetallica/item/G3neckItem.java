...
public class G3neckItem extends MemetallicaModElements.ModElement {
	@ObjectHolder("memetallica:g_3neck")
	public static final Item block = null;
	public G3neckItem(MemetallicaModElements instance) {
		super(instance, 51);
	}
